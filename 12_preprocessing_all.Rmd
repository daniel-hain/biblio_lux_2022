...
# mat_cit <- readRDS(paste0('../temp/temp/mat_cit_', str_to_lower(var_inst), '_', str_to_lower(var_dept), '.rds'))
```
...
find_topics %>% FindTopicsNumber_plot() # Taking 11 topics
```
...
%>% serVis(out.dir = paste0('output/LDAviz_', str_to_lower(var_inst), '_', str_to_lower(var_dept), '.rds'))
```
