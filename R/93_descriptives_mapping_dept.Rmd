---
title: "Luxembourg Research Institute Evaluation 2022: Mapping of Knowledge Structure: Department internal"
...
* This document: `r paste0('https://daniel-hain.github.io/biblio_lux_2022/output/field_mapping_', str_to_lower(var_inst), '_', str_to_lower(var_dept), '.html')`
* Mapping of broad research field: `r paste0('https://daniel-hain.github.io/biblio_lux_2022/output/field_mapping_dept_', str_to_lower(var_inst), '_', str_to_lower(var_dept), '.html')`
...
g_agg <- readRDS(paste0('../../temp/g_bib_agg_', str_to_lower(var_inst), '_', str_to_lower(var_dept), '.rds')) %N>%
  arrange(com) %N>%  mutate(com = com_names_bib %>% pull(label)) %E>%
